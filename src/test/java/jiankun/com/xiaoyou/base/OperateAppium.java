...
import static jiankun.com.xiaoyou.base.InitAppium.appPackage;
...
public class OperateAppium {
    ...
    public OperateAppium(AndroidDriver<WebElement> androidDriver) {
    ...
    public AndroidElement waitAutoByClassName(String className) {
        return waitAutoByXp(className, WAIT_TIME);
    }

    public AndroidElement waitAutoByClassName(String className, int time) {
        return waitAuto(By.xpath(className), time);
    }
    ...
    /**
     * 
     * MethodsInfo:Android物理按键返回操作
     * 2017年2月17日 下午3:57:12
     * @param webElement
     */
    public void back(){
